...
FRESULT pf_open    (FATFS *fs, const char*);					/* Open a file */
FRESULT pf_read    (FATFS *fs, void*, WORD, WORD*);			/* Read data from the open file */
...
FRESULT pf_opendir (FATFS *fs, DIR*, const char*);			/* Open a directory */
FRESULT pf_readdir (FATFS *fs, DIR*, FILINFO*);			/* Read a directory item from the open directory */
